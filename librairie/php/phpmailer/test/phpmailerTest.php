...
EOT;
    ...
    public function testPopBeforeSmtpGood() {
        ...
        $this->assertTrue(
                POP3::popBeforeSmtp('localhost', 1100, 10, 'user', 'test', 0), 'POP before SMTP failed'
        );
    ...
    public function testPopBeforeSmtpBad() {
        ...
        $this->assertFalse(
                POP3::popBeforeSmtp('localhost', 1101, 10, 'user', 'xxx', 0), 'POP before SMTP should have failed'
        );
        shell_exec('kill -TERM ' . escapeshellarg($pid));
        sleep(2);
    }
