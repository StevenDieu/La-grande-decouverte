    ...
    if ($('#edit').editable('getHTML', false, false) !== "" && $('.titre').val() !== "" && $('#id').val() !== "" && $('#id_carnetvoyage').val() !== "") {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result === "1") {
                    couleurAlerteCss(".form-control.titre", {"border": " 1px #3c763d solid"}, {"border": "1px solid #cccccc"});
        ...
        if ($(".titre").val() === "" && $('#edit').editable('getHTML', false, false) === "") {
            couleurAlerteCss(".form-control.titre", {"border": " 1px #a94442 solid"}, {"border": " 1px solid #cccccc"});
