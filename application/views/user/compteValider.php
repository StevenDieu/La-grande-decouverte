...
<div class="content" style="display: block; visibility: visible;">
    <div class="content-inscription">
        <div class="legend">Votre compte vient d'être valider.</div>  
        <form method="post" accept-charset="utf-8"> 
            <div class="left">
                ...
                <?php if (isset($mail)) { ?>
                    ...
                    <br/><br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;<label for="nom" class="">Félicitation, vous venez de vous inscrire à LAGRANDEDECOUVERTE.</label><br/><br/>

                    &nbsp;&nbsp;&nbsp;&nbsp;<label for="nom" class="">Vous pouvez désormais vous connecter : </label><br/><br/><br/>

                    &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('user/account/connexion') ?>" class="bblue">Me connecter</a>
                    <br/><br/>
                    <div class="alertType">
                    </div>
