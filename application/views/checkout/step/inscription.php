<form action="#" class="adress_form">
    <div class="all_text_field">
        <div class="address_fields_left">
            <p><input class="required" name="inscription_nom" id="inscription_nom" type="text" placeholder="Votre Nom*" /></p>
        </div>
        <div class="address_fields_left address_fields_rgt">
            <p><input class="required" name="inscription_prenom" id="inscription_prenom" type="text" placeholder="Votre Prénom*" /></p>
        </div>
    </div>
    <div class="address_fields">
        <div class="address_fields_left">
            <p><input class="required mail" name="inscription_email" id="inscription_email" type="mail" placeholder="Votre Email*" /></p>
        </div>
        <div class="address_fields_left address_fields_rgt">
    ...
    <div class="address_fields last">
        ...
        <div class="address_fields_left address_fields_rgt">
            <p><input class="required cmdp" name="inscription_confirmer_mdp" id="inscription_confirmer_mdp" type="password" placeholder="Confirmation de votre mot de passe*"  /></p>
        </div>
    </div>
