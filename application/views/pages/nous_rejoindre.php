<div class="content">
    <div class="contentPageSansSlide mentionLegales">
        ...
        Vous recevez un email de confirmation<br/>
        dès réception de votre candidature par notre service Ressources Humaines<br/>
        Nous vous recontactons dans un délai d’un mois<br/>
        si votre profil correspond à l'un de nos besoins<br/>
        <br/>
        <br/>
        Vous êtes de plus en plus nombreux à vouloir participer à l’aventure Voyage Privé et nous sommes ravis de cet engouement. Il nous est toutefois impossible d'apporter une réponse personnalisée à chacune des candidatures. Si notre équipe ne vous recontacte pas, par téléphone,  dans un délai d'un mois, veuillez considérer que votre candidature n'a pas été retenue pour le poste souhaité. Néanmoins et sauf avis contraire de votre part, ttnous conservons votre dossier pendant deux ans dans notre base de données.<br/>
        <br/>
        <br/>
        <br/>
