<div class="content ">
    <div class="contentPageSansSlide">
        ...
        <p><br></p>
        <h3>5.1.13 Perte ou vol de billets d'avion</h3>
        <p><br></p>
        ...
        <p><br></p>
        <h2>ARTICLE 6 - CONDITIONS APPLICABLES AUX PRESTATIONS HOTELIERES SEULES ET RESIDENCES DE TOURISME—</h2>
        ...
        <p><br></p>
        <p><h4>6.2.2 Chambres doubles </h4></p>
        <p><br></p>
        ...
        <p><br></p>
        <p>En outre, pour bien préparer votre voyage, et quelque soit votre nationalité, nous vous conseillons vivement de consulter toutes les informations sur les pays à visiter et sur les démarches administratives et sanitaires à accomplir sur les sites Internet suivants http://www.diplomatie.gouv.fr/fr/conseils-aux-voyageurs_909/index.html, sans oublier les pays éventuellement traversés à l'occasion d'escales ou de transits.</p>
        <p><br></p>
        <p>L'accomplissement de ces formalités ainsi que les frais en résultant vous incombent.</p>
        <p><br></p>
        <p>Les formalités mentionnées sur le site s’adressent à des ressortissants français. Par conséquent, les ressortissants des pays étrangers doivent impérativement se renseigner préalablement à leur inscription auprès des autorités compétentes de leur pays d’origine, ainsi que du ou des pays de destination et/ou de transit.</p>
        <p><br></p>
        <p>Entre la parution des informations sur le site et la date du départ de l'Utilisateur, certaines modifications sont susceptibles d'intervenir. LGD conseille donc à l'Utilisateur de consulter le site juste avant son départ.</p>
        <p><br></p>
        <p>Enfin, il vous appartient de respecter scrupuleusement ces formalités et de vous assurer que les noms et prénoms qui figurent sur vos documents de voyages (réservations, titres de transport, bons d'échange...) correspondent exactement à ceux qui figurent sur leur pièce d'identité, passeport, visas, etc.</p>
        <p><br></p>
        <p>Si du fait du non respect de ces formalités administratives ou sanitaires, vous vous trouviez dans l’impossibilité d’embarquer ou de débarquer, le prix payé ne pourrait en aucun être remboursé. De même LGD ne saurait supporter les frais d’amende et/ou de droits résultant de l’inobservation des règlements douaniers ou sanitaires de pays visités.</p>
        <p>ARTICLE 12 - PREUVE—</p>
        <p>En application des dispositions de l’article 1316-2 du code civil, il est expressément convenu que sauf erreur manifeste de LGD, les données conservées dans le système d’information de LGD et/ou de leur partenaires et/ou prestataires, notamment dans les outils de messagerie électroniques utilisés ont force probante quant aux commandes passées et à l’exécution des obligations des parties. Les données sur support informatique ou électronique ainsi conservées constituent des preuves, et si elles sont produites comme moyen de preuve par LGD dans toute procédure contentieuse ou autre, elles seront recevables, valables et opposables entre les parties de la même manière, dans les mêmes conditions et avec la même force probante que tout document qui serait établi, reçu ou conservé par écrit.</p>
        <p>ARTICLE 13 - DROIT DE RETRACTATION—</p>
        <p>En application des dispositions de l’article L 121-21-8 du code de la consommation les prestations proposées sur le site par LGD ne sont pas soumises à l’application du droit de rétractation prévu aux articles L 121-21 et suivants du code de la consommation en matière de vente à distance.</p>
        <p>En conséquence, les prestations commandées sur le site sont exclusivement soumises aux conditions d’annulation et de modification prévues aux présentes conditions générales de vente et l’utilisateur ne pourra pas invoquer le droit à rétractation.</p>
        <p>ARTICLE 14 – ANNULATION – MODIFICATION – CESSION PAR L’UTILISATEUR—</p>
        <p>14.1 - MODALITES D’ANNULATION OU DE MODIFICATION</p>
        <p><br></p>
        <p>14.1.1 Dispositions générales</p>
        <p><br></p>
        <p>Toute demande d'annulation ou de modification de votre commande devra parvenir à LGD impérativement par courrier électronique aux adresses suivantes : modification@lagrandecouverte.com ou annulation@lagrandecouverte.com ou par téléphone au numéro suivant 0 892 426 425 (0.34€ la minute) ou encore plus simplement directement sur le site dans l’espace « mon compte » , « ma commande » en cliquant sur le choix « demande d’annulation » ou « demande modification ».</p>
        <p><br></p>
        <p>LGD vous transmettra en retour, par courrier électronique, le cas échéant, la confirmation de la réception de votre demande d'annulation ou de modification. En l'absence de ce courrier électronique, la modification ou l'annulation ne pourra pas être prise en compte. Il vous appartient donc dans tous les cas de vous assurer de la bonne réception du courrier électronique de confirmation.</p>
        <p><br></p>
        <p>Dans un souci de sécurité juridique et de transparence, LGD vous rappellera alors dans ce courrier électronique le barème d'annulation ou de modification tel que prévu aux présentes, aux articles 14.2 et 14.3 ci-dessous, et vous demandera de lui retourner dans un délai précisé le courrier électronique suivant : « « J’ai bien pris note du montant des frais d’annulation (ou de modification selon le cas) cité ci-dessus, je confirme l’annulation (ou la modification) de ma prestation. Nom, prénom, référence du dossier», avec la mention « bon pour accord » pour confirmer votre demande d’annulation ou de modification.</p>
        <p><br></p>
        <p>Seul l’envoi de ce courrier électronique par vos soins vaudra demande d’annulation ou de modification définitive. Par conséquent, l’envoi d’un tel courrier électronique hors délai pourra, le cas échéant, faire augmenter les frais dans les conditions du barème d’annulation ou de modification prévu aux articles 14.2 et 14.3 ci-dessous car tant que celui-ci n’aura pas été adressé la réservation sera maintenue comme initialement, LGD restant elle-même engagée à l’égard de son prestataire auprès duquel elle aura réservée la prestation ;</p>
        <p><br></p>
        <p>En cas de modification ou d'annulation, et sous déduction des sommes dues en application des stipulations des articles 14.2 et 14.3 des présentes, LGD vous remboursera dans un délai raisonnable toutes les sommes préalablement versées, sous réserve éventuellement des dispositions particulières propres à certaines prestations telles que visées à l’article 14.1.2 ci-dessous.</p>
        <p><br></p>
        <p>De votre côté, l'annulation ou la modification de votre prestation pour quelque raison que ce soit ne vous dispense pas du paiement des sommes dont vous resteriez redevable auprès de LGD en application des dispositions du présent article.</p>
        <p><br></p>
        <p>LGD attire enfin l’attention de l’utilisateur sur le fait que les frais extérieurs ou non compris dans la prestation, et d'ores et déjà engagés par lui tels que ceux engagés pour la délivrance des visas, autres documents de voyage, frais de pré-acheminnement ou de post-achemninement, frais de vaccination..., ne pourront faire l'objet d’aucun remboursement.</p>
        <p><br></p>
        <p>Lorsque vous avez souscrit une assurance annulation, nous vous rappelons qu'il vous appartient d'informer directement l'assureur de l'annulation ou de tout autre sinistre dans les conditions et délais indiqués au contrat d’assurance.</p>
        <p><br></p>
        <p>14.1.2 - Dispositions particulières à certaines prestations</p>
        <p><br></p>
        <p>Par exception, certaines prestations ou forfaits pourront faire l’objet de conditions d’annulation particulières qui s’appliqueront par dérogation aux dispositions générales ci-dessus. Ces conditions particulières figureront dans le descriptif</p>
        <p>S’agissant des forfaits touristiques, des prestations hôtelières des résidences de tourisme et de la location saisonnière, LGD entend rappeler à l’utilisateur que, tout séjour interrompu ou abrégé ou toute prestation non consommée de son fait pour quelque cause que ce soit, telle que par exemple non présentation ou de présentation hors délai sur le lieu de rendez-vous, ne donnera lieu à aucun remboursement. Par ailleurs, en cas d'annulation pour insuffisance de participants, au plus tard 22 jours avant la date du départ, le client ne pourra prétendre à aucune indemnité.</p>
        <p>Les assurances ne sont jamais remboursables.</p>
        <p>Les frais de dossiers ne sont jamais remboursables.</p>
        <p><br></p>
        <p>14.2 - BAREME ET FRAIS EN CAS D’ANNULATION PAR L’UTILISATEUR</p>
        <p><br></p>
        <p>L'annulation de votre prestation entraîne des frais qui vous sont facturés selon le barème ci-dessous.</p>
        <p><br></p>
        <p>14.2.1 Pour les prestations de vols sec</p>
        <p><br></p>
        <p>Vols réguliers :</p>
        <p>Annulation avant ou après départ</p>
        <p>100 % du montant total TTC</p>
        <p><br></p>
        <p>Il convient à cet effet de rappeler que dans le cas d’un billet électronique, le billet est émis dès la commande.</p>
        <p><br></p>
        <p>14.2.2 Pour les prestations hôtelières seules, les résidences de tourisme</p>
        <p><br></p>
        <p>Prestation hôtelière seule et résidence de tourisme</p>
        <p>A   30 jours avant le départ</p>
        <p>30 % du montant total TTC</p>
        <p>Entre 30 et 16 jours avant le départ</p>
        <p>55 % du montant total TTC</p>
        <p>Entre 15 et 7 jours avant le départ</p>
        <p>75 % du montant total TTC</p>
        <p>A moins de sept jours du départ et après le départ</p>
        <p>100% du montant total TTC</p>
        <p><br></p>
        <p>14.2.3 Pour les prestations de loisir ou de restauration</p>
        <p><br></p>
        <p>Soin à la journée</p>
        <p>Annulation avant ou après la date prévue pour la prestation</p>
        <p>100% du montant total TTC</p>
        <p><br></p>
        <p>14.2.4 Pour les forfaits touristiques et croisières</p>
        <p><br></p>
        ...
        <p><br></p>
        <p><br></p>
        <p>14.2.5 Pour le package dynamique</p>
        <p><br></p>
        <p><br></p>
        <p>Package dynamique</p>
        <p>A   30 jours avant le départ</p>
        <p>30 % du montant total TTC des prestations hors vol 100% du montant du vol TTC</p>
        <p>Entre 30 et 16 jours avant le départ</p>
        <p>55 % du montant total du montant total TTC 100% du montant du vol TTC</p>
        <p>Entre 15 et 7 jours avant le départ</p>
        <p>75 % du montant total TTC 100% du montant du vol TTC</p>
        <p>A moins de sept jours du départ et après le départ</p>
        <p>100% du montant total TTC 100% du montant du vol TTC</p>
        <p><br></p>
        <p><br></p>
        <p>14.2.6 Pour la location saisonnière</p>
        <p><br></p>
        <p>Le cas particulier d’annulation des prestations de location saisonnière est prévue dans les conditions spécifiques qui figurent dans le descriptif de l’offre, et qui sont celles de nos prestataires. A défaut, les conditions d’annulation suivantes s’appliquent</p>
        <p><br></p>
        <p>Prestation de location saisonnière seule</p>
        <p>A   45 jours avant le départ</p>
        <p>30 % du montant total TTC</p>
        <p>Entre 44 et 30 jours avant le départ</p>
        <p>55 % du montant total TTC</p>
        <p>Entre 29 jours et 16 jours avant le départ</p>
        <p>75 % du montant total TTC</p>
        <p>A moins de 15 jours du départ et après le départ</p>
        <p>100% du montant total TTC</p>
        <p>14.2.7 Pour l'Eurostar</p>
        <p><br></p>
        <p><br></p>
        <p>Eurostar</p>
        <p>A   30 jours avant le départ</p>
        <p>30 % du montant total TTC des prestations hors vol 100% du montant du train TTC</p>
        <p>Entre 30 et 16 jours avant le départ</p>
        <p>55 % du montant total du montant total TTC 100% du montant du train TTC</p>
        <p>Entre 15 et 7 jours avant le départ</p>
        <p>75 % du montant total TTC 100% du montant du train TTC</p>
        <p>A moins de sept jours du départ et après le départ</p>
        <p>100% du montant total TTC 100% du montant du train TTC</p>
        <p><br></p>
        <p>14.3 - BAREME ET FRAIS EN CAS DE MODIFICATION PAR L’UTILISATEUR</p>
        <p><br></p>
        <p>Pour toutes nos prestations, les frais suivants s’appliquent :</p>
        <p>- Frais de gestion de la modification : 16€ par dossier</p>
        <p>- Application des frais fournisseurs liés à la modification</p>
        <p><br></p>
        <p>A noter, en cas de suppression de prestations nos conditions d’annulations s’appliquent.</p>
        <p>ARTICLE 15 - ANNULATION OU MODIFICATION PAR LA SOCIETE LGD ET/OU SES PRESTATAIRES—</p>
        <p>15.1 d’une prestation de « vol sec »</p>
        <p><br></p>
        <p>Les dossiers aériens sont soumis à acceptation technique de notre service billetterie qui peut se trouver en situation d'infaisabilité d'émission du billet. En effet certaines compagnies (en particulier les petites compagnies assurant des vols intérieurs et certaines " low cost", (compagnies aériennes à bas prix) ont passé des contrats partiels avec les systèmes aériens leur permettant d'être réservées sans pour autant rendre possible l'émission des titres de transport en France. Dans ce dernier cas, LGD s'engage à informer l’utilisateur de cet état de faits dans les 48 h suivant la confirmation d'enregistrement de la commande et, dans la mesure du possible, et à faire ses meilleurs efforts pour proposer une autre solution d'acheminement aérien accompagnée de nouvelles conditions tarifaires.</p>
        <p>Si, au moment de l’émission, qui intervient après la réservation, le transporteur n’autorise pas le billet électronique, que le délai d’acheminement du titre de transport physique n’est pas possible et qu’aucune autre solution aux mêmes conditions n’est disponible, l’organisateur se réserve le droit d’annuler sans frais la réservation effectuée, le prix payé étant alors remboursé.</p>
        <p>Il convient, par ailleurs, de rappeler une nouvelle fois que dans le cadre de l'achat de billets d'avion LGD agit en qualité de simple intermédiaire entre le transporteur et l'utilisateur. Le transporteur peut imposer à LGD, sur certains vols, à certaines dates, où pour bénéficier de certains tarifs, de règles d'émissions particulières telles que l'émission du billet dans un délai maximum après la réservation, l'accès à certains tarifs réservés aux résidents de certains pays notamment. Dans le cas où ces règles d'émission imposées par le transporteur à LGD trouveraient à s'appliquer à l'utilisateur, LGD sera en droit d'annuler sans frais la réservation effectuée et de rembourser le prix payé.</p>
        <p><br></p>
        <p>En tout état de cause, en cas d’annulation d’une prestation de vol sec par la compagnie aérienne, l’ensemble des sommes versées vous seraient restituées sans que la responsabilité de LGD puisse être, par ailleurs, engagée aux fins d’obtenir quelque indemnisation que ce soit.</p>
        <p><br></p>
        <p>15.2 d’un forfait touristique</p>
        <p><br></p>
        <p>Si LGD était contrainte d'annuler votre voyage, vous seriez immédiatement prévenus, et l'ensemble des sommes versées vous seraient immédiatement restituées et les dispositions de l’article R 211-10 du code du Tourisme s’appliqueraient (cf. article 21 ci-après).</p>
        <p><br></p>
        <p>De la même manière si une modification devait intervenir avant le départ, les dispositions de l’article R 211-9 s’appliqueraient (cf. article 21 ci-après).</p>
        <p><br></p>
        <p>15.3 d’une prestation du package dynamique</p>
        <p><br></p>
        <p>Dans le cas où l’utilisateur assemble deux prestations distinctes proposées par sur un site LGD, dans le cadre d’un package dynamique, les sommes engagées au titre de la prestation annulée par le prestataire de LGD vous seraient immédiatement remboursées dans les meilleurs délais sans, par ailleurs, que LGD soit tenue de rembourser tout autre prestation que l’utilisateur auraient achetés dans ce cadre sur les sites.</p>
        <p><br></p>
        <p>
    </div>
</div>