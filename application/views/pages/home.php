...
<div class="content content-home">
    <?php if ((isset($voyages) && !empty($voyages)) || (isset($voyages_by_choice) && !empty($voyages_by_choice))) { ?>
        ...
        <div class="divLeTireurVoyage">
            <svg class="blurpVoyage" width="192" height="61" viewBox="0 0 160.7 61.5" >
            <path fill="#FFFFFF" d="M80.3,61.5c0,0,22.1-2.7,43.1-5.4s41-5.4,36.6-5.4c-21.7,0-34.1-12.7-44.9-25.4S95.3,0,80.3,0c-15,0-24.1,12.7-34.9,25.4S22.3,50.8,0.6,50.8c-4.3,0-6.5,0,3.5,1.3S36.2,56.1,80.3,61.5z">
            </path>
            </svg>
            <span class="ancreVoyage">
