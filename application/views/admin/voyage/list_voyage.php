...
if($voyages){
	...
	echo "<table><tr><th>id</th><th>titre</th><th>prix</th><th>supprimer</th></tr>";
	foreach ($voyages as $voyage) {
		echo '<tr><td>'.$voyage->id.'</td><td><a href="'.base_url('admin/voyages/edit').'?id='.$voyage->id.'">'.$voyage->titre.'</a></td><td>'.$voyage->prix.'</td>
