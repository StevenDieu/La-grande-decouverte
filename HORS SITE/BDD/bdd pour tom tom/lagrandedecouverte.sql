...
-- Généré le :  Sam 25 Juillet 2015 à 19:00
...
(60, '2015-07-12', '2015-07-22', 'deroule', 'deroule', '', '', '', 11, 122, 0, 1, 26);
...
INSERT INTO `order` (`id`, `id_voyage`, `id_utilisateur`, `id_billing`, `id_info_voyage`, `nb_participant`, `payment`, `acompte`, `ip`, `prix_total`, `reste_a_payer`, `sous_total`, `taxe`, `date`) VALUES
(1, 25, 1, 5, 58, 1, 'PAYPAL', '1,00', '::1', '10,02', '9,02', '8,02', '2,00', '2015-07-25 15:02:18'),
(2, 26, 1, 5, 60, 1, 'CHECKMO', '12,20', '::1', '122,00', '109,80', '97,60', '24,40', '2015-07-25 17:34:32');
